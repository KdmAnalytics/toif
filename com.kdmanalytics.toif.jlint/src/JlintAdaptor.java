...
public class JlintAdaptor extends AbstractAdaptor
{
    ...
    /* (non-Javadoc)
     * @see com.kdmanalytics.toif.framework.toolAdaptor.AbstractAdaptor#getAdaptorVersion()
     */
    @Override
    ...
    public ArrayList<Element> parse(Process process, AdaptorOptions options, File file)
    {
        ...
        // new finding creator
        FindingCreator creator = new FindingCreator(getProperties(), getAdaptorName());
    ...
    /* (non-Javadoc)
     * @see com.kdmanalytics.toif.framework.toolAdaptor.AbstractAdaptor#getGeneratorVendorDescription()
     */
    @Override
