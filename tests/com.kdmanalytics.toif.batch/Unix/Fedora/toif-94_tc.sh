...
findingCount1=$(find ${outDir} -wholename "/home/kdm/TOIF/output3/Fake.class.jlint.toif.xml" | xargs grep "toif:Finding\"" | wc -l)
findingCount2=$(find ${outDir} -wholename "/home/kdm/TOIF/output3/Fake.class.jlint" | xargs grep "Test.java:1" | wc -l)
