...
toif --adaptor=findbugs --inputfile=C:\TOIF\TestFiles\Java\Tuple.class --outputdirectory=c:\TOIF\output3 --housekeeping=C:\toif-1.16.0-SNAPSHOT\Examples\Housekeeping
toif --adaptor=jlint --inputfile=C:\TOIF\TestFiles\Java\Tuple.class --outputdirectory=c:\TOIF\output3 --housekeeping=C:\toif-1.16.0-SNAPSHOT\Examples\Housekeeping
