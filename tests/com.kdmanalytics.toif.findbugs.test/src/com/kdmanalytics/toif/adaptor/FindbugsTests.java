...
public class FindbugsTests {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(FindbugsTests.class);
  ...
  public void testGetAdaptorDescription() {
    assertEquals("Find Bugs in Java Programs with the added functionality of the security plugin.", fba
  ...
  public void testGetAdaptorVendorAddress() {
    assertEquals("1956 Robertson Road, Suite 204, Ottawa ON, K2H 5B9", fba.getAdaptorVendorAddress());
  ...
  public void testGetGeneratorDescription() {
    assertEquals("Static code analysis tool that analyses Java bytecode and detects a wide range of problems.", fba
  ...
  public void testGetGeneratorVendorAddress() {
    assertEquals("http://findbugs.sourceforge.net/", fba.getGeneratorVendorAddress());
  }
  
  @Test
  public void testGetGeneratorVendorDescription() {
    assertEquals("SourceForge is a web-based source code repository.", fba.getGeneratorVendorDescription());
  }
  ...
  public void testGetGeneratorVersion() {
    ...
    try {
      ...
      // called.
      Mockito.doReturn(is).when(fbMock).startProcess(Mockito.any(ProcessBuilder.class));
    } catch (IOException e) {
  ...
  public void testRunToolCommandsLinux() {
    ...
    String expected[] = new String[] {
                                       "findbugs", "-xml", "-Dblah", "-Ifoo", "Test.class"
    };
    
    Assert.assertArrayEquals("Expected:" + Arrays.toString(expected) + " GOT:" + Arrays.toString(runToolCommands),
                             expected, runToolCommands);
  }
  ...
  public void testRunToolCommandsWindows() {
    ...
    expected = new String[] {
                              "cmd.exe", "/C", "findbugs.bat", "-xml", "-Dblah", "-Ifoo", "Test.class"
    };
