...
public class CompareFileTest
{
    ...
    public void compareFiles() throws IOException
    {
        ...
        String[] args = { "-k", outputFile.toString(), "resources/javaOutput.kdm", "resources/TOIF/FindBugs Adaptor/NamesConversion.class.toif.xml","resources/TOIF/JLint Adaptor/NamesConversion.class.toif.xml" };
        try
			{
