...
public class MergerUtilities {
   ...
   * @param statements
   */
  private <T, E extends Exception> void closeQuietly(RepositoryConnection con,
                                                     CloseableIteration<Statement, RepositoryException> statements) {
   ...
   * 
   * @param uri
   * @return First found parent URI, or null if no parent found. An error is written to stderr if
   *         there is more then one parent found.
  ...
  /**
   * Simple function that creates a predicate based on the provided string predicate name.
   * 
   * @param pred
   * @return
   */
  ...
  /**
   * Returns the requested RDF Attribute as a string value. This version is used for the rare cases
  ...
  /**
   * Same as getRDFAttribute, but returns the result as a "Value" as opposed to a "String".
   * 
   * @param name
   * @param name
   * @return
