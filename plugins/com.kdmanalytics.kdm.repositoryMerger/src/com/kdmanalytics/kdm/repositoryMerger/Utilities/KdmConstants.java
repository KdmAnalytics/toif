...
public class KdmConstants {
  ...
  public enum WorkbenchStereotype {
    /**
     * Elements that the Workbench should not display are stereotyped as hidden.
     */
    HIDDEN("__HIDDEN__"),
    /**
     * KDM's specially managed Structure Models should be stereotyped in a special way. This allows
     * us to know which models we should do additional processing for inside the various probes.
     */
    MANAGED_STRUCTURE_MODEL("__MANAGED__"),
    
    /**
     * Elements that the Workbench should not delete are stereotyped as undeletable
     */
    CANNOT_DELETE_MODEL("__UNDELETABLE__"),
    /**
     * User created models are marked because they have some special functionality, such as special
     * persistence into future builds.
     */
    USER_MODEL("__USER_MODEL__"),
    /**
     * Mark a node as containing user data. This is required for proper persistence between builds.
     */
    ...
    /**
     * Set to indicate we are overriding the UID. On load of such a model, the target UID is
     * discovered through various heuristics.
     */
    ...
    /**
     * Indicates that the aggregated relationships have been pre-calculated for this diagram
     */
    CACHED_AGGREGATES("__CACHED_AGGREGATED_RELATIONSHIPS__"),
    
    /**
     * Indicates that this is a generated model such as an Overview or API model.
     */
    ...
    /**
     * Indicates that the UIDs have been refined (specified) below this level, where normally they
     * would not.
     */
    REFINED("__REFINED__"),
    
    /**
     * Indicates that the specified platform resource has content defined by the specified data
     * resource.
     */
    HAS_CONTENT("__HAS_CONTENT__"),
    
    /**
     * The default context indicates to workbench which model is the preferred owner model for
     * elements that do not have a prescribed context.
     */
