...
public class JlintAdaptor extends AbstractAdaptor
{
	 ...
	 */
	@Override
	public ArrayList<Element> parse(java.io.File process, AdaptorOptions options, IFileResolver resolver, boolean[] validLines, boolean unknownCWE) throws ToifException
	{
	...
	public String[] runToolCommands(AdaptorOptions options, String[] otherOpts)
	{
		...
		final String[] commands = { execPath, options.getInputFile().toString() };
