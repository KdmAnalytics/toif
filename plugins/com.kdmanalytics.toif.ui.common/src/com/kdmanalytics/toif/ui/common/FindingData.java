...
public class FindingData {
  ...
  /**
   * Set to false when we have performed a citing. This is used to pop up a warning on the first
   * citing of any Eclipse run.
   */
   ...
   * @param sfp
   */
  protected void setFindingData(IFile resource, String tool, String description, int line, int offset, String cwe,
                                String sfp) {
  ...
  public String toString() {
    return "[" + tool + "] " + resource.toString() + ":" + line + "," + offset + " - {" + sfp + "," + cwe + "} "
           + description;
  }
  ...
  /**
   * Return the line number that KDM reported as being the finding location.
   * 
   * @return
   */
  ...
  /**
   * The trust level for a finding is defined for ALL findings of the same tool/cwe type.
   * 
  ...
  /**
   * Return a string that contains all text for the finding that we wish to have searchable. The
