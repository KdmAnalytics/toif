...
public class FindingEntry extends ReportItem implements IFindingEntry {
  ...
  public FindingEntry(Value value) {
    isOk = Citing.UNKNOWN;
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFindingEntry#equals(java .lang.Object)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFindingEntry#getChildren()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFindingEntry#getDescription ()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFindingEntry#getFindingEntries ()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFindingEntry#getFindingId()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFindingEntry#getSearchableText ()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFindingEntry#setCwe(java .lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFindingEntry#setDescription
   * (java.lang.String)
   */
  @Override
  ...
  public void setIsOk(Citing isOk) {
    this.isOk = isOk;
  }
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFindingEntry#setSfp(java .lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFindingEntry#setTrust(int)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFindingEntry#getTraces()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFindingEntry#setTraces(java .util.List)
   */
  @Override
