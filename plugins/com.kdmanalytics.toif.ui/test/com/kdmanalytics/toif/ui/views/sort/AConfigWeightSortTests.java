 ...
 *
 */
public class AConfigWeightSortTests {
  ...
  public void testConfigSortByGrouping() throws IOException {
    ...
    List<IFindingEntry> findings = new LinkedList<IFindingEntry>();
    findings.add(new FindingEntry(new File("A"), "Findbugs", "VA_FORMAT_STRING", 172, 0, "CWE-133", "SFP--1"));
    findings.add(new FindingEntry(new File("B"), "Jlint", "shadow_local", 175, 0, "CWE-133", "SFP--1"));
