...
class FindingStyledLabelProvider extends StyledCellLabelProvider {
    ...
    private static final Color FOREGROUND_BLACK = new Color(PlatformUI.getWorkbench().getDisplay(),
	    new RGB(80, 80, 80));
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.jface.viewers.CellLabelProvider#getToolTipText(java.lang.
     * Object)
     */
    @Override
     ...
     * 
     * @see
     * org.eclipse.jface.viewers.StyledCellLabelProvider#update(org.eclipse.jface.
     * viewers.ViewerCell)
     */
