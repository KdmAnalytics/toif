...
public class FilePathTree {
  ...
  /**
   * Add a parent-directory to the directory. Remember that we are working from the file, up the
   * directories.
   * 
   * @param dir
  ...
  public class Node {
    ...
    /**
     * Add a parent to this directory. It sounds count-intuitive that this directory might have many
     * parents. However, we must remember that it is not a directory but a directory-name. This
     * means that there may be more then one directory with the same name, but they are contained in
    ...
    /**
     * get the parent from this file's parents which has the same name as parentName
     * 
     * @param parentName
