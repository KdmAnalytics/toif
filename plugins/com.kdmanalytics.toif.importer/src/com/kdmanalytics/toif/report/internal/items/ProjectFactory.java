 ...
 ******************************************************************************/
// /////////////////////////////////////////////////////////////////////////////
// Copyright (c) 2016 KDM Analytics, Inc.
// All rights reserved.
// /////////////////////////////////////////////////////////////////////////////
...
public class ProjectFactory {
   ...
   */
  public static IToifProject createProjectModel(IFolder folder, Repository myRepository, boolean workbenchPresent,
    ...
    Project project = new Project(folder, myRepository, workbenchPresent);
    ...
    try {
      ...
      for (FileGroup fileGroup : fileGroupings) {
        ...
        for (LocationGroup locations : addLocationGroupings(project, fileGroup)) {
          progress.setTaskName("Processing findings for location: " + fileGroup.getName() + ":" + locations
                                                                                                           .getLineNumber());
   ...
   */
  private static void initCodeLocationCache(IToifProject project) throws QueryEvaluationException, RepositoryException,
   ...
   * @throws QueryEvaluationException
   */
  private static List<FileGroup> addFileGroupings(final Project project) throws RepositoryException,
   ...
   * @throws QueryEvaluationException
   */
  private static List<ToolGroup> addFindings(final IToifProject project, LocationGroup locationGroup)
   ...
   * @throws QueryEvaluationException
   */
  private static List<LocationGroup> addLocationGroupings(IToifProject project, FileGroup file)
      throws RepositoryException, MalformedQueryException, QueryEvaluationException {
    RepositoryConnection con = project.getRepositoryConnection();
   ...
   * @throws QueryEvaluationException
   */
  private static int getFinding(IToifProject project, LocationGroup locationGroup, CachedCodeLocation ccl)
      throws RepositoryException, MalformedQueryException, QueryEvaluationException {
    int count = 0;
   ...
   * @throws QueryEvaluationException
   */
  private static String getCwe(final IToifProject project, Value finding) throws RepositoryException,
      MalformedQueryException, QueryEvaluationException {
    RepositoryConnection con = project.getRepositoryConnection();
   ...
   * @throws QueryEvaluationException
   */
  private static String getWeaknessDescription(final IToifProject project, Value finding) throws RepositoryException,
      MalformedQueryException, QueryEvaluationException {
    RepositoryConnection con = project.getRepositoryConnection();
   ...
   * @throws QueryEvaluationException
   */
  private static ToolGroup getTool(IToifProject project, Value finding) throws RepositoryException,
      MalformedQueryException, QueryEvaluationException {
   ...
   * @throws QueryEvaluationException
   */
  private static String getSfp(final IToifProject project, Value finding) throws RepositoryException,
      MalformedQueryException, QueryEvaluationException {
    RepositoryConnection con = project.getRepositoryConnection();
   ...
   * @throws QueryEvaluationException
   */
  private static List<Trace> getTraces(final IToifProject project, Value finding) throws RepositoryException,
      MalformedQueryException, QueryEvaluationException {
    RepositoryConnection con = project.getRepositoryConnection();
