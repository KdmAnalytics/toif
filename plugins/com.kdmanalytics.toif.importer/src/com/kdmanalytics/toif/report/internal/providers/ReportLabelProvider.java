...
import com.kdmanalytics.toif.importer.Activator;
 ...
 */
public class ReportLabelProvider extends StyledCellLabelProvider implements ITableLabelProvider, ITableColorProvider,
    IFontProvider {
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.jface.viewers.StyledCellLabelProvider#paint(org.eclipse.swt .widgets.Event,
   * java.lang.Object)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.jface.viewers.StyledCellLabelProvider#update(org.eclipse.
