...
/**
 * class representing a file group. file groups represent a file in toif. files contain findings and
 * tools.
 * 
...
public class FileGroup extends ReportItem implements IFileGroup {
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFileGroup#AddLocation(com
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFileGroup#getFindingEntries ()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFileGroup#getFindingEntriesNotOk ()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFileGroup# getFindingEntriesNotOkTrustSum()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFileGroup#getLocationGroup()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.kdmanalytics.toif.report.internal.items.IFileGroup#getSearchableText ()
   */
  @Override
