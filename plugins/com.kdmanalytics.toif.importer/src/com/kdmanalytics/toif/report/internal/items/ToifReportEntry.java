...
public class ToifReportEntry extends PlatformObject implements IToifReportEntry
{
     ...
     *            the finding entry
     */
    public ToifReportEntry(IToifProject project, IFileGroup fileGroup, LocationGroup locationGroup, ToolGroup toolGroup, FindingEntry findingEntry)
    {
     ...
     * 
     * @see
     * com.kdmanalytics.toif.report.internal.items.IToifReportEntry#getProject()
     */
    @Override
     ...
     * 
     * @see
     * com.kdmanalytics.toif.report.internal.items.IToifReportEntry#setProject
     ...
     * 
     * @see
     * com.kdmanalytics.toif.report.internal.items.IToifReportEntry#getFileGroup
     * ()
     */
    @Override
     ...
     * 
     * @see
     * com.kdmanalytics.toif.report.internal.items.IToifReportEntry#setFileGroup
     ...
     * 
     * @see
     * com.kdmanalytics.toif.report.internal.items.IToifReportEntry#getLocationGroup
     * ()
     */
    @Override
     ...
     * 
     * @see
     * com.kdmanalytics.toif.report.internal.items.IToifReportEntry#setLocationGroup
     ...
     * 
     * @see
     * com.kdmanalytics.toif.report.internal.items.IToifReportEntry#getToolGroup
     * ()
     */
    @Override
     ...
     * 
     * @see
     * com.kdmanalytics.toif.report.internal.items.IToifReportEntry#setToolGroup
     ...
     * 
     * @see
     * com.kdmanalytics.toif.report.internal.items.IToifReportEntry#getFindingEntry
     * ()
     */
    @Override
     ...
     * 
     * @see
     * com.kdmanalytics.toif.report.internal.items.IToifReportEntry#setFindingEntry
