...
public class TOIFSegmentIsGeneratedByPerson extends Fact
{   
    private Segment segment;
    private Person person;
    
    public TOIFSegmentIsGeneratedByPerson() {
        super();
        type = "toif:TOIFSegmentIsGeneratedByPerson";
    }
    
    public TOIFSegmentIsGeneratedByPerson(Segment segment, Person person)
    {
        super();
        type = "toif:TOIFSegmentIsGeneratedByPerson";
