...
/** Given an input path, returns the absolute path to the file. This
 * is used to resolve the file paths provided by the various tools.
 * For example, FindBugs returns the file path starting from the
 * top of the sourcePath (package + filename).
 * 
 * @author Ken Duck
 *
 */
