 ...
 * 
 */
public class ExportCitationHandler extends AbstractHandler implements IHandler
{
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException
    {
        ...
        List<FindingEntry> findingEntries = view.getReportInput().getFindingEntries();
        
        if ((findingEntries == null) || (findingEntries.size() == 0))
        {
            return null;
        }
        ...
        try
        {
            ...
            writeHeader(writer);
            writeFindings(findingEntries, writer);
     ...
     * 
     * @param findingEntries
     *            the selected element from the report
     * @param writer
     *            the file writer to use to output
     * @throws IOException
     */
    private void writeFindings(List<FindingEntry> findingEntries, FileWriter writer) throws IOException
    {
