...
public interface IToifFacade
{
    ...
    /**
     * get all the avaliable adaptors that can be run.
     * 
     * @param lang
     *            the enumerated value of the language that you need the adaptor
     *            to be for.
     ...
     * @throws TOIFExecuteException
     */
    boolean merge(File kdmOutputFile, File kdmFile, Set<File> toifFiles, boolean createZip) throws TOIFExecuteException;
     ...
     * @throws TOIFExecuteException
     */
    boolean merge(File kdmOutputFile, Set<File> toifFiles, boolean createZip) throws TOIFExecuteException;
